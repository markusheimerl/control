...
def run_simulation():
    ...
    # Accelerations
    linear_acceleration_W = addVec3f([0, -g * m, 0], multMatVec3f(R_W_B, f_B_thrust))
    linear_acceleration_W = multScalVec3f(1 / m, linear_acceleration_W)
    angular_acceleration_B = addVec3f(crossVec3f(multScalVec3f(-1, angular_velocity_B), multMatVec3f(loc_I_mat, angular_velocity_B)), tau_B)
