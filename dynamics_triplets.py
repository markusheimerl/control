...
def run_simulation():
    ...
    cumulative_reward = 0
    state_action_reward_triplets = []

    for iteration in range(max_iterations):
        # Sample random rotor speeds
        omega_1 = random.uniform(omega_min, omega_max)
        omega_2 = random.uniform(omega_min, omega_max)
        omega_3 = random.uniform(omega_min, omega_max)
        omega_4 = random.uniform(omega_min, omega_max)

        # Store the action
        action = [omega_1, omega_2, omega_3, omega_4]
        ...
        # Store the state
        state = imu_accel_reading + imu_gyro_reading
        ...
        # Store the state-action-reward triplet
